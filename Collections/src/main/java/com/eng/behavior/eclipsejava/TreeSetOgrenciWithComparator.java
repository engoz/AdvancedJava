 ...
 */
public class TreeSetOgrenciWithComparator {

    public static void main(String[] args) {
        TreeSet<Ogrenci> ogrenciler = new TreeSet<Ogrenci>(new OgrenciSoyadComparator());
        ogrenciler.add(new Ogrenci(100, "engin", "oz", "5"));
        ogrenciler.add(new Ogrenci(110, "can", "oz", "3"));
        ogrenciler.add(new Ogrenci(10, "ozlem", "terzioglu", "5"));
